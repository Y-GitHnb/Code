...
#define UART2_Rx_COUNT 200
#define UART3_Rx_COUNT 200

	extern uint8_t UART1_data[REC_LENGTH];
	extern uint8_t UART1_Rx_Buf[UART1_Rx_COUNT];
	extern volatile uint16_t UART1_Rx_cnt;

	extern uint8_t UART2_data;
	extern uint8_t UART2_Rx_Buf[UART2_Rx_COUNT];
	extern volatile uint16_t UART2_Rx_cnt;
	extern volatile uint8_t UART2_Rx_flag;

	extern uint8_t UART3_Rx_Buf[UART3_Rx_COUNT];
	extern volatile uint16_t UART3_Rx_cnt;
